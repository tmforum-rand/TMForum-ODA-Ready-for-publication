...
var pmCollection = require('./TMF657-ServiceQualityManagement-v4.0.0.testkit.json');
...
function exportEnvironment(url) {
    ...
    envJson.values.forEach(element => {
        if (element.key == "Service_Quality_Management") {
