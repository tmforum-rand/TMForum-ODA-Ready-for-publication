...
Feature: Dependent API interaction testing for TMFC008 - Service Inventory
  ...
  Examples:
    ...
    | tmfc008            | serviceCatalog     | service      | TMF638       | service    | TMF633         | serviceSpecification | service-catalog-0001.json | service-target-0001.json  | serviceSpecification | createService | success          |
    | tmfc008            | serviceCatalog     | service      | TMF638       | service    | TMF633         | serviceSpecification | service-catalog-0001.json | service-target-0002.json  | serviceSpecification | createService | failure          |
