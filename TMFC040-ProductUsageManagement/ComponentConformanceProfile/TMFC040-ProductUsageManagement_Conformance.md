# TMFC040 – ProductUsageManagement – v1.2.0

## Mandatory Exposed APIs (Require Conformance)

- **TMF635 – Usage Management API**
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/OpenApiTable/TMF635_Usage/4.0.0/swagger/TMF635_Usage_Management_API_v4.0.0_swagger.json

*(Conformance MUST support one of the specified versions above.)*

- **TMF677 – Usage Consumption Management API**
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/OpenApiTable/TMF677_Usage_Consumption/5.0.0/swagger/TMF677-Usage_Consumption-v5.0.0.oas.yaml
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/OpenApiTable/TMF677_Usage_Consumption/4.0.0/swagger/TMF677_Usage_Consumption_Management_API_v4.0.0_swagger.json
...
manifest — this flag does not override TMF669's status as the canvas-identity API.

**TMF672 (User Role Permission Management API)** is also present under the Security Function, but is
marked `required: false` and is not otherwise promoted to mandatory elsewhere in the spec. It is therefore
present-but-ignored for conformance purposes.
...
```json
{
    ...
    "ctkconfig": {
        ...
        "productName": "REFERENCE EXAMPLE PRODUCT USAGE MANAGEMENT",
