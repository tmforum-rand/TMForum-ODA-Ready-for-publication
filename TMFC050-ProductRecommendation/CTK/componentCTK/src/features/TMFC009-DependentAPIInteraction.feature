@tmfc009
Feature: Dependent API interaction testing for TMFC009 - Service Qualification Management
  ...
  Examples:
    ...
    | tmfc009            | serviceCatalog     | checkServiceQualification | TMF645       | checkServiceQualification | TMF633         | serviceSpecification | service-catalog-0001.json | service-target-0001.json  | serviceQualificationItem[0].service.serviceSpecification | createCheckServiceQualification | success          |
    | tmfc009            | serviceCatalog     | checkServiceQualification | TMF645       | checkServiceQualification | TMF633         | serviceSpecification | service-catalog-0001.json | service-target-0002.json  | serviceQualificationItem[0].service.serviceSpecification | createCheckServiceQualification | failure          |
