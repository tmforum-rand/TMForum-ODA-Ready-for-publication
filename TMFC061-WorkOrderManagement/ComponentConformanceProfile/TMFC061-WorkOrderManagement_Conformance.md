# TMFC061 – WorkOrderManagement – v1.1.0

## Mandatory Exposed APIs (Require Conformance)

- **TMF713 – v4.0.0** <!-- API name not found in apiIndex.json or Ready-for-publication apiIndex lookup — fill in manually -->
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/Beta/TMF713_Work_Management/4.0.0/swagger/TMF713_Work_Management_v4.0.0_beta_swagger.json

- **TMF697 – v4.0.0** <!-- API name not found in apiIndex.json or Ready-for-publication apiIndex lookup — fill in manually -->
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/Beta/TMF697_Work_Order/4.0.0/swagger/TMF697_Work_Order_Management_API_v4.0.0_beta_swagger.json

- **TMF714 – v4.0.0** <!-- API name not found in apiIndex.json or Ready-for-publication apiIndex lookup — fill in manually -->
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/Beta/TMF714_Work_Qualification/4.0.0/swagger/TMF714_Work_Qualification_Management_v4.0.0_beta_swagger.json

- **TMF701 – v4.1.0** <!-- API name not found in apiIndex.json or Ready-for-publication apiIndex lookup — fill in manually -->
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/Beta/TMF701_Process_Flow/4.1.0/swagger/TMF701_Process_Flow_Management_API_v4.1.0_beta_swagger.json

- **TMF688 – v4.0.0** <!-- API name not found in apiIndex.json or Ready-for-publication apiIndex lookup — fill in manually -->
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/Beta/TMF688_Event/4.0.0/swagger/TMF688_Event_Management_API_v4.0.0_beta_swagger.json
...
- **TMF646 – Appointment Management API**
  Swagger:
  - https://tmf-open-api-table-documents.s3.eu-west-1.amazonaws.com/OpenApiTable/TMF646_Appointment/4.0.0/swagger/TMF646_Appointment_Management_API_v4.0.0_swagger.json
...
```json
{
    ...
    "ctkconfig": {
        ...
        "productName": "REFERENCE EXAMPLE WORK ORDER MANAGEMENT",
