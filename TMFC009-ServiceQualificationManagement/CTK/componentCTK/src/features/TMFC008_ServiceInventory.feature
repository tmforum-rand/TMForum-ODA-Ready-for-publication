...
Feature: Dependent API interaction testing for TMFC008 - Service Inventory
  ...
  Examples:
    ...
    | tmfc008            | serviceCatalog     | serviceSpecification | service     | serviceSpecification | service-catalog-0001.json  | service-target-0001.json  | createService      | success          |
    | tmfc008            | serviceCatalog     | serviceSpecification | service     | serviceSpecification | service-catalog-0001.json  | service-target-0002.json  | createService      | failure          |
