...
var pmCollection = require('./CTK-Service_Qualification-4.0.0.postman_collection.json');
...
function exportEnvironment(url) {
    ...
    envJson.values.forEach(element => {
        if (element.key == "Service_Qualification") {
