...
Feature: Dependent API interaction testing for TMFC012 - Resource Inventory
  ...
  Examples:
    ...
    | tmfc012            | resourceCatalog    | resource     | TMF639       | resource   | TMF634         | resourceSpecification | resource-catalog-0001.json | resource-target-0001.json | resourceSpecification | createResource | success          |
    | tmfc012            | resourceCatalog    | resource     | TMF639       | resource   | TMF634         | resourceSpecification | resource-catalog-0001.json | resource-target-0002.json | resourceSpecification | createResource | failure          |
