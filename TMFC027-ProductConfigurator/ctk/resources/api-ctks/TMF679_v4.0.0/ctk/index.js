...
var pmCollection = require('./TMF679-ProductOfferingQualification.json');
...
function exportEnvironment(url) {
    ...
    envJson.values.forEach(element => {
        if (element.key == "Product_Offering_Qualification_API") {
